...
public class Assignment1 
{
	public static void main(String[]args)
	{
		...
		which happens when overflow in a data type occurs. The value is truncated to fit into the data type range, which 
		explains why a false negative value appears*/
